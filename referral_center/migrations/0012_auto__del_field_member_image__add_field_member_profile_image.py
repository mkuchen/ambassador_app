...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'referral_center_member', 'image')

        # Adding field 'Member.profile_image'
        db.add_column(u'referral_center_member', 'profile_image',
                      self.gf('cloudinary.models.CloudinaryField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Member.image'
        db.add_column(u'referral_center_member', 'image',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Member.profile_image'
        db.delete_column(u'referral_center_member', 'profile_image')
    ...
    models = {
        ...
        u'referral_center.member': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile_image': ('cloudinary.models.CloudinaryField', [], {'max_length': '100', 'null': 'True'}),

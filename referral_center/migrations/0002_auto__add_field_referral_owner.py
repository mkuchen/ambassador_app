...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Referral.owner'
        db.add_column(u'referral_center_referral', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Referral.owner'
        db.delete_column(u'referral_center_referral', 'owner_id')

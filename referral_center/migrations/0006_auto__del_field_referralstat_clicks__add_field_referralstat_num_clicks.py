...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReferralStat.clicks'
        db.delete_column(u'referral_center_referralstat', 'clicks')

        # Adding field 'ReferralStat.num_clicks'
        db.add_column(u'referral_center_referralstat', 'num_clicks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReferralStat.clicks'
        db.add_column(u'referral_center_referralstat', 'clicks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ReferralStat.num_clicks'
        db.delete_column(u'referral_center_referralstat', 'num_clicks')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Referral.date_submitted'
        db.add_column(u'referral_center_referral', 'date_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Referral.date_submitted'
        db.delete_column(u'referral_center_referral', 'date_submitted')

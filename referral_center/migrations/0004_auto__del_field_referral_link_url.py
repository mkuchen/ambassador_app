...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Referral.link_url'
        db.delete_column(u'referral_center_referral', 'link_url')


    def backwards(self, orm):
        # Adding field 'Referral.link_url'
        db.add_column(u'referral_center_referral', 'link_url',
                      self.gf('django.db.models.fields.CharField')(default='BLANK', max_length=500),
                      keep_default=False)

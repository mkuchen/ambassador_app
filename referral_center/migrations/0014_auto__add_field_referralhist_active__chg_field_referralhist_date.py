...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferralHist.active'
        db.add_column(u'referral_center_referralhist', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'ReferralHist.date'
        db.alter_column(u'referral_center_referralhist', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'ReferralHist.active'
        db.delete_column(u'referral_center_referralhist', 'active')


        # Changing field 'ReferralHist.date'
        db.alter_column(u'referral_center_referralhist', 'date', self.gf('django.db.models.fields.DateTimeField')(default=None))

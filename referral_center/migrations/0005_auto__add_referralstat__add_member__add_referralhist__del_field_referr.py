...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReferralStat'
        db.create_table(u'referral_center_referralstat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clicks', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'referral_center', ['ReferralStat'])

        # Adding model 'Member'
        db.create_table(u'referral_center_member', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'referral_center', ['Member'])
        ...
        # Deleting field 'Referral.clicks'
        db.delete_column(u'referral_center_referral', 'clicks')


    def backwards(self, orm):
        # Deleting model 'ReferralStat'
        db.delete_table(u'referral_center_referralstat')

        # Deleting model 'Member'
        db.delete_table(u'referral_center_member')

        # Deleting model 'ReferralHist'
        db.delete_table(u'referral_center_referralhist')

        # Adding field 'Referral.clicks'
        db.add_column(u'referral_center_referral', 'clicks',

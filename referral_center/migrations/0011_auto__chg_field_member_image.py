...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'referral_center_member', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Member.image'
        db.alter_column(u'referral_center_member', 'image', self.gf('django.db.models.fields.TextField')(null=True))

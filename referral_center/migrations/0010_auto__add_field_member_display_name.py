...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.display_name'
        db.add_column(u'referral_center_member', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='Referral Marketing Solutions', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.display_name'
        db.delete_column(u'referral_center_member', 'display_name')

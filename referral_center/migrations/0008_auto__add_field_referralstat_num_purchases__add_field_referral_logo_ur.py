...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'referral_center_referral', 'logo_url',
                      self.gf('django.db.models.fields.CharField')(default='http://wp.streetwise.co/wp-content/uploads/2012/05/Blank-Label-logo.jpg', max_length=1000),
                      keep_default=False)
        ...
        db.add_column(u'referral_center_referral', 'banner_text',
                      self.gf('django.db.models.fields.CharField')(default='get hacking!', max_length=1000),
                      keep_default=False)
        ...
        db.alter_column(u'referral_center_referral', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['referral_center.Member'], null=True))

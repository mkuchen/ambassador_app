...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReferralHist.clicks'
        db.delete_column(u'referral_center_referralhist', 'clicks')


    def backwards(self, orm):
        # Adding field 'ReferralHist.clicks'
        db.add_column(u'referral_center_referralhist', 'clicks',
